                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item text-center" href="#">
                                        <img src="/dulce/Imagen/usuario4-peque.png" alt="60" width ="60"/>
                                    </a></li>
                                
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item text-center" href="/dulce/vistas/login.jsp">Iniciar Sesion</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <div>
                                    ...
                                    <a href="/dulce/CtrProducto?accion=Comprar&id=${p.getId()}" class="btn btn-danger">Comprar</a>
                                </div>
                            </div>
                        </div>
                    </div>
