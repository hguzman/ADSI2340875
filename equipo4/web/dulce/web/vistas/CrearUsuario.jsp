<%-- 
    ...
    Created on : 4/10/2022, 09:40:59 AM
    Author     : HPLAPTOP01
--%>
...
<html>
    ...
    <body style="background: buttonface">
        ...
        <div class="container mt-2 border">
                <div class="row">
                    ...
                    <div class="col-sm-8 border mt-2 mb-2">
                        <form action="../ctrlUsuario?accion=nuevo" class="formulario" id="formulario">
                            <div class="form-row">
                                <!-- Identificacion-->
        ...
        <script src="/dulce/JS/Validar.js" type="text/javascript"></script>
