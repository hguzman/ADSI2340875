...
<html>
    ...
    <body>
                        ...
                        <form action="/PROYECTOFARMACIA/CtrUsuario?accion=Actualizar" class="formulario" id="formulario">
                            <div class="form-row">
                                ...
                                <div class ="col formulario__grupo" id="grupo__identificacion">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="text" class="formulario__input" name = "id" id="id" value=${u.getId()} readonly>
                                ...
                                <div class ="col formulario__grupo" id="grupo__correo">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="email" class="formulario__input" name = "correo" id="correo" value=${u.getCorreo()}>
                                        <i class="formulario__validacion-estado fa fa-times-circle"></i>
                                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class ="col formulario__grupo" id="grupo__nombre">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="text" class="formulario__input" name = "nombre" id="nombre" value=${u.getNombre()}>
                                        <i class="formulario__validacion-estado fa fa-times-circle"></i>
                                    </div>
                                ...
                                <div class ="col formulario__grupo" id="grupo__apellido">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="text" class="formulario__input" name = "apellido" id="apellido" value=${u.getApellido()}>
                                        <i class="formulario__validacion-estado fa fa-times-circle"></i>
                                    </div>
                             ...
                             <div class="form-row">
                                ...
                                <div class ="col formulario__grupo" id="grupo__direccion">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="text" class="formulario__input" name = "direccion" id="direccion" value=${u.getDireccion()}>
                                        <i class="formulario__validacion-estado fa fa-times-circle"></i>
                                    </div>
                                ...
                                <div class ="col formulario__grupo" id="grupo__telefono">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="text" class="formulario__input" name = "telefono" id="telefono" value=${u.getTelefono()}>
                                        <i class="formulario__validacion-estado fa fa-times-circle"></i>
                                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class ="col formulario__grupo" id="grupo__usuario">
                                    ...
                                    <div class="formulario__grupo-input">
                                        <input type="text" class="formulario__input" name = "usuario" id="usuario" value=${u.getUsuario()}>
                                        <i class="formulario__validacion-estado fa fa-times-circle"></i>
                                    </div>
                                ...
                                <div class ="col formulario__grupo" id="grupo__tipo">
                                    <input type="hidden" value="${u.getTipo()}" name ="tipo" id="tipo" >
        ...
        <script src="/PROYECTOFARMACIA/JS/validar2.js" type="text/javascript"></script>
