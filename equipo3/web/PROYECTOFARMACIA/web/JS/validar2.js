...
formulario.addEventListener('submit', (e) => {
    const terminos = document.getElementById('terminos');
     console.log(campos.idetificacion);
    if (campos.correo && campos.nombre && campos.apellido && campos.direccion && campos.telefono && campos.usuario && campos.contrasena && terminos.checked){
