...
formulario.addEventListener('submit', (e) => {
    ...
    if (campos.identificacion && campos.correo && campos.nombre && campos.apellido && campos.direccion && campos.telefono && campos.usuario && campos.contrasena){
       
    }else{
        e.preventDefault();
        console.log("Entró a formulario error"); 
