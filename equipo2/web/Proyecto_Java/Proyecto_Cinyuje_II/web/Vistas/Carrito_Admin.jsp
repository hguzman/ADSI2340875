<%-- 
    Document   : Carrito_Admin
    Created on : 20/09/2022, 09:29:12 AM
    Author     : HPLAPTOP01
--%>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item"  href="#" data-bs-target="#item"><i class="fa fa-shopping-basket" aria-hidden="true"></i> Productos</a></li>
                            <li><a class="dropdown-item" href="#" <i class="fa fa-cubes" aria-hidden="true"></i> Categorías</a></li>
                            <li><a class="dropdown-item" href="#" <i class="fa fa-users" aria-hidden="true"></i> Usuarios</a> </li>
                        </ul>      
                    </li>                    
                </ul>
